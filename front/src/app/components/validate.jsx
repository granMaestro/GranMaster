...
const validation = Object.assign(Validation.rules, {
    ...
    required: {
        ...
        hint: value => {
            return <span className='form-error is-visible'>Obligatorio</span>
        }
    },
    email: {
        ...
        hint: value => {
            return <span className='form-error is-visible'>Inserta un email valido.</span>
        }
    },
    ...
    password: {
        ...
        hint: () => <span className="form-error is-visible">Passwords do not match.</span>
    },
